...
> **Quick Setup & Overview** - Start automating your trading with RubyMT4 (Ruby for MetaTrader 4) in minutes.

---

## 🎯 What is RubyMT4?

**RubyMT4** is an industrial-grade, type-safe Ruby client library for interacting with **MetaTrader 4** terminals via high-performance **gRPC**. It eliminates complex C++ DLL wrappers and provides direct, reliable programmatic trading.
...
Install RubyMT4 via your standard Ruby package manager:
...
To get the most out of RubyMT4, follow this suggested reading order:
